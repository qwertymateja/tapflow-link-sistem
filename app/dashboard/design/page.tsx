          ...
          <div className="space-y-5">
            ...
            {profile.background_type === 'gradient' && (
              <div>
                ...
                <label className="block text-sm font-medium text-gray-700 mb-1">Custom CSS gradient</label>
                <input type="text" value={profile.background_gradient}
                  onChange={e => updateProfile({ background_gradient: e.target.value })}
